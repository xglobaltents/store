        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-8">
            ...
            <ol className="list-decimal list-inside space-y-2">
              <li><strong>Contact Us:</strong> Email us at <a href="mailto:cs@xglobal-tents.com" className="text-blue-600 hover:underline">cs@xglobal-tents.com</a> or call 04 836 9499</li>
          ...
          <section className="mb-8">
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              ...
              <p><strong>Phone:</strong> 04 836 9499 (Available 9 AM - 6 PM GST, Sunday - Thursday)</p>
